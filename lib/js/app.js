...
var app = angular.module('musicApp', ['ui.router', 'LocalStorageModule']);
...
app.config(function ($stateProvider, $urlRouterProvider) {
	...
	}).state('musicParent.noiseCtrl', {
		url: 'noise/:id',
		controller: 'NoiseController as noiseCtrl',
		templateUrl: './templates/noise.html'
	});
});